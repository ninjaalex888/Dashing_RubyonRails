...
(function() {
  ...
  Batman.Filters.dateFormat = function(date) {
  ...
  Batman.Filters.durationFormat = function(duration) {
  ...
  Dashing.BuildWindow = (function(superClass) {
    extend(BuildWindow, superClass);

    function BuildWindow() {
      return BuildWindow.__super__.constructor.apply(this, arguments);
    }

    var health;

    BuildWindow.prototype.ready = function() {
      ...
      if (this.node.getAttribute("status") === 'Failed') {
        return $(this.node).css('background-color', '#a73737');
      } else if (this.node.getAttribute("status") === 'Successful') {
        return $(this.node).css('background-color', '#03A06E');
      }
    };

    BuildWindow.prototype.onData = function(data) {
      ...
      var link;
      link = this.get('urlLink');
      if (data.status === 'Failed') {
        $(this.node).css('background-color', '#a73737');
      } else if (data.status === 'Successful') {
        $(this.node).css('background-color', '#03A06E');
      }
      this.node.querySelector("#mylink")['href'] = link;
      this.accessor('tc', function() {
        return this.get('tc') === 1;
      });
      this.accessor('jk', function() {
        return this.get('jk') === 1;
      });
      return this.accessor('so', function() {
        return this.get('so') === 1;
      });
    };

    BuildWindow.accessor('image', function() {
      var health;
      ...
      if (health >= 80) {
        return '/assets/health-80plus.svg';
      } else {
        return '/assets/health-00to19.svg';
      }
    });

    BuildWindow.accessor('show-health', function() {
      var health;
      if (this.get("health") == null) {
        health=this.node.getAttribute("health");
      } else {
...
(function() {
  ...
  Dashing.Countdown = (function(superClass) {
    ...
    Countdown.prototype.startCountdown = function() {
      var current_timestamp, d, dayname, end_timestamp, h, i, j, m, results, s, seconds_until_end;
      ...
      if (seconds_until_end < 0) {
        ...
        results = [];
        for (i = j = 0; j <= 100; i = j += 1) {
          results.push($(this.node).fadeTo(1200, 0).fadeTo(1200, 1.0));
        }
        return results;
      } else {
...
(function() {
  ...
  Dashing.GithubStatus = (function(superClass) {
    extend(GithubStatus, superClass);

    function GithubStatus() {
      return GithubStatus.__super__.constructor.apply(this, arguments);
    }

    GithubStatus.prototype.ready = function() {
      return this.onData(this);
    };

    GithubStatus.prototype.onData = function(data) {
      var widget;
      widget = $(this.node);
      ...
      return widget.find('#message').removeClass("good minor major").addClass(data.status);
    };
...
(function() {
  ...
  Dashing.GoogleColumn = (function(superClass) {
    extend(GoogleColumn, superClass);

    function GoogleColumn() {
      return GoogleColumn.__super__.constructor.apply(this, arguments);
    }

    GoogleColumn.accessor('current', function() {
      var points;
    ...
    GoogleColumn.prototype.ready = function() {
      var colors, container, height, width;
      ...
      colors = null;
      if (this.get('colors')) {
        colors = this.get('colors').split(/\s*,\s*/);
      }
      this.chart = new google.visualization.BarChart($(this.node).find(".chart")[0]);
      this.options = {
        height: height,
        width: width,
        colors: colors,
        ...
        isStacked: this.get('is_stacked'),
        legend: {
          position: this.get('legend_position')
        },
        animation: {
          duration: 500,
          easing: 'out'
      ...
      this.data = google.visualization.arrayToDataTable(eval(responseT));
      return this.chart.draw(this.data, this.options);
    };

    GoogleColumn.prototype.onData = function(data) {
      if (this.chart) {
        this.data = google.visualization.arrayToDataTable(data.points);
        return this.chart.draw(this.data, this.options);
      }
    };
...
(function() {
  ...
  Dashing.GoogleLine = (function(superClass) {
    extend(GoogleLine, superClass);

    function GoogleLine() {
      return GoogleLine.__super__.constructor.apply(this, arguments);
    }

    GoogleLine.accessor('current', function() {
      var points;
      if (this.get('displayedValue')) {
        return this.get('displayedValue');
      }
    ...
    GoogleLine.prototype.ready = function() {
      this.node.querySelector("#mylink")['href'] = this.node.getAttribute("urlLink");
      var colors, container, height, points, width;
      container = $(this.node).parent();
      width = (Dashing.widget_base_dimensions[0] * container.data("sizex")) + Dashing.widget_margins[0] * 2 * (container.data("sizex") - 1);
      height = Dashing.widget_base_dimensions[1] * container.data("sizey");
      colors = null;
      ...
      this.chart = new google.visualization.LineChart($(this.node).find(".chart")[0]);
      this.options = {
        height: height,
        width: width,
        colors: colors,
        ...
        vAxis: {
          format: this.get('vaxis_format')
        },
        curveType: this.get('curve_type')
      };
      if (this.get('points')) {
        this.data = google.visualization.arrayToDataTable(this.get('points'));
      } else {
        var points=this.node.getAttribute("points");
        points = points.replace(/nil/g, 'null');
        this.data = google.visualization.arrayToDataTable(eval(points));
      }
      return this.chart.draw(this.data, this.options);
    };

    GoogleLine.prototype.onData = function(data) {
      if (this.chart) {
        this.data = google.visualization.arrayToDataTable(data.points);
        return this.chart.draw(this.data, this.options);
      }
...
(function() {
  ...
  Dashing.GooglePie = (function(superClass) {
    extend(GooglePie, superClass);

    function GooglePie() {
      return GooglePie.__super__.constructor.apply(this, arguments);
    }

    GooglePie.prototype.ready = function() {
      var colors, container, height, width;
      if (this.node.getAttribute("urlLink").length>2) {
        this.node.querySelector("#mylink")['href'] = this.node.getAttribute("urlLink");
      }
      ...
      this.chart = new google.visualization.PieChart($(this.node).find(".chart")[0]);
      this.options = {
        height: height,
        width: width,
        ...
        is3D: this.get('is_3d'),
        pieHole: 0.4,
        pieStartAngle: this.get('pie_start_angle'),
      ...
      this.data = google.visualization.arrayToDataTable(eval(slices));
      return this.chart.draw(this.data, this.options);
    };

    GooglePie.prototype.onData = function(data) {
      if (this.chart) {
        this.data = google.visualization.arrayToDataTable(data.slices);
        return this.chart.draw(this.data, this.options);
      }
    };
...
(function() {
  ...
  Dashing.Number1 = (function(superClass) {
    extend(Number1, superClass);

    function Number1() {
      return Number1.__super__.constructor.apply(this, arguments);
    }

    Number1.prototype.ready = function() {
      this.node.querySelector("#mylink")['href'] = this.node.getAttribute("urlLink");
      this.node.querySelector("#value").textContent  = this.node.getAttribute("total");
      return this.node.querySelector("#updated").textContent = this.node.getAttribute("updated");
    };

    Number1.accessor('current', Dashing.AnimatedValue);

    Number1.accessor('difference', function() {
    ...
    Number1.accessor('arrow', function() {
      if (this.get('last')) {
    ...
    Number1.prototype.onData = function(data) {
      if (data.status) {
...
(function() {
  ...
  Dashing.Table = (function(superClass) {
    ...
    Table.prototype.ready = function() {
      if (this.node.getAttribute("urlLink").length>2) {
        return this.node.querySelector("#mylink")['href'] = this.node.getAttribute("urlLink");
      }
    };
...
(function() {
  ...
  Dashing.Timeline = (function(superClass) {
    ...
    Timeline.prototype.ready = function() {
      ...
      if (this.node.getAttribute("events").length>2) {
        ...
        event=eval(events5);
        return this.renderTimeline(event);
      }
    };

    Timeline.prototype.onData = function(data) {
      if (data.events) {
        return this.renderTimeline(data.events);
      }
    };

    Timeline.prototype.renderTimeline = function(events) {
      return TimeKnots.draw(".timeline", events, {
