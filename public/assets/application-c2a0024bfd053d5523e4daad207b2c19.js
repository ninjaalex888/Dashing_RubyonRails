...
(function() {
  ...
  Dashing.BuildWindow = (function(superClass) {
    ...
    BuildWindow.prototype.onData = function(data) {
      ...
      console.log("urlLink " + this.get('urlLink'));
      ...
      console.log("tc is" + this.get('tc'));
      console.log("jk is" + this.get('jk'));
...
(function() {
  ...
  Dashing.GoogleColumn = (function(superClass) {
    ...
    GoogleColumn.prototype.ready = function() {
      ...
      this.chart = new google.visualization.ColumnChart($(this.node).find(".chart")[0]);
      this.options = {
        height: height,
        width: width,
        colors: colors,
...
(function() {
  ...
  Dashing.GooglePie = (function(superClass) {
    ...
    GooglePie.prototype.ready = function() {
      ...
      if (this.get('slices')) {
        this.data = google.visualization.arrayToDataTable(this.get('slices'));
      } else {
        this.data = google.visualization.arrayToDataTable([]);
      }
      return this.chart.draw(this.data, this.options);
...
(function() {
  ...
  Dashing.Timeline = (function(superClass) {
    ...
    Timeline.prototype.ready = function() {
      return this.renderTimeline(this.get('events'));
    };
